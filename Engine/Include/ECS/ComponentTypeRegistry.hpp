...
#define REGISTER_COMPONENT(ClassName) \
    ...
    friend struct ComponentTypeRegistry::Registrar<ClassName>; \
    inline static ComponentTypeRegistry::Registrar<ClassName> ClassName##_registrar = ComponentTypeRegistry::Registrar<ClassName>(#ClassName);
}
